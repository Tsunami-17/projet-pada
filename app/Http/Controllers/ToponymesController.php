...
class ToponymesController extends Controller
{
    ...
    {
        //
        $Toponymes = Toponymes::select('commune')->distinct()->orderBy('commune','asc')->get();
        return view('pages.denomination', compact('Toponymes'));
    ...
    {
        //
        $Tries = Toponymes::select('typologie')->distinct()->where('commune',$toponymes->commune)->orderBy('typologie','asc')->get();
        return $Tries;
    }
